...
const Payment = () => {
        ...
        const subscription = paymentSSEService.subscribeToPaymentEvents(
            order.order_number,
            {
                    ...
                    setOrder((prev) => ({
                        ...
                        payment_details: {
                            ...
                            transaction_id:
                                ...
                                paymentData.sepay_transaction_id,
                ...
                onPaymentFailed: (paymentData) => {
                    ...
                    message.error(
                        `Thanh toán thất bại: ${
                            paymentData.webhook_data?.reason ||
                            'Lỗi không xác định'
                        }`
                    )
                ...
                onPaymentUpdate: (paymentData) => {
                    ...
                    message.info(
                        `Đang xử lý thanh toán: ${paymentData.payment_status}`,
                        2
                    )
                },
                ...
                onError: (error) => {
                    ...
                    message.warning(
                        'Kết nối realtime gặp sự cố. Kiểm tra thủ công nếu cần...',
                        3
                    )
                },
    ...
    useEffect(() => {
        return () => {
            if (
                ...
                typeof realtimeSubscription.unsubscribe === 'function'
            ) {
    ...
    const checkPaymentStatus = async () => {
        ...
        try {
            ...
            const response = await paymentAPI.checkSepayStatus(
                order.order_number
            )
    ...
    const handleManualConfirm = () => {
        Modal.confirm({
            ...
            content:
                'Bạn đã hoàn tất việc chuyển khoản chưa? Shop sẽ xác minh và xử lý đơn hàng của bạn.',
    ...
    const handleCancelPayment = () => {
        Modal.confirm({
            ...
            content:
                'Bạn có chắc muốn hủy thanh toán? Đơn hàng vẫn sẽ được giữ để bạn thanh toán sau.',
                    ...
                    >
                        <Space direction="vertical" style={{ width: '100%' }}>
                            ...
                            <div>
                                ...
                                >
                                    ⚠️ Vui lòng chuyển khoản đúng nội dung để
                                    được xử lý tự động
                                </Text>
                            </div>
                        </Space>
