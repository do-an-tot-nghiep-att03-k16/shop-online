...
class CouponRepository {
    ...
    static async findActiveCoupons({ skip = 0, limit = 10 } = {}) {
        const now = new Date()
        return await coupon
            .find({
                is_active: true,
    ...
    static async findByCategory(categoryId, { skip = 0, limit = 10 } = {}) {
        const now = new Date()
        return await coupon
            .find({
                is_active: true,
    ...
    static async findByProduct(productId, { skip = 0, limit = 10 } = {}) {
        const now = new Date()
        return await coupon
            .find({
                is_active: true,
